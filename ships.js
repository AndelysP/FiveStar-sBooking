const ships = [
    {
        name: "Pollen",
        description: "Bienvenue à bord de Pollen ! Comme une abeille travaille dur pour polliniser les fleurs et produire du miel, Pollen est conçu pour vous transporter efficacement et confortablement à travers les étoiles. En tant que pollinisateurs de la galaxie, nous prenons soin de nos passagers avec les mêmes soins que les abeilles prennent de leur ruche. Profitez d'un voyage confortable et sûr grâce à notre technologie de pointe, nos sièges douillets et notre espace de détente. Nos chefs cuisiniers talentueux préparent des repas délicieux et équilibrés pour vous en amont, tout en préservant les ingrédients frais pour une expérience gustative inoubliable. Notre équipe d'experts en navigation vous guidera à travers les galaxies avec facilité et assurance, tout en vous présentant des curiosités cosmiques fascinantes. Pollen vous promet une expérience de voyage unique en son genre, pleine d'aventures, de découvertes et de douceur. Réservez votre place dès maintenant et devenez un membre de notre ruche galactique !",
        premium_food: false,
